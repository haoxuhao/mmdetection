...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=[
                data_root + 'voc-style/split_dataset_new/ImageSets/Main/train.txt',
                #data_root + 'VOC2012/ImageSets/Main/trainval.txt'
            ],
            img_prefix=[data_root + 'voc-style/split_dataset_new'],
            img_scale=[(608, 608), (1080, 1080)],#(1080, 1080)
...
log_level = 'INFO'
work_dir = './work_dirs/ga_retinanet_x50_32x4d_fpn_1x_multi_scale_split_new'
load_from = None
resume_from = None
