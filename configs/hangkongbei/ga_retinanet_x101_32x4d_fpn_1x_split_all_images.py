...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=[
                data_root + 'voc-style/split_dataset/ImageSets/Main/trainval.txt',
                #data_root + 'VOC2012/ImageSets/Main/trainval.txt'
            ],
            img_prefix=[data_root + 'voc-style/split_dataset'],
            img_scale=[(600, 600), (980, 980)],#(1080, 1080)
    ...
    test=dict(
        ...
        # img_prefix = data_root+"testset/split_images_new/",
        #ann_file = data_root+"testset/ImageSets/test_split.txt",
        #img_prefix=data_root + 'testset/split_images/',
        img_scale=[(608,608),(1080,1080)],
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
        flip_ratio=0,
        with_mask=False,
...
log_level = 'INFO'
work_dir = './work_dirs/ga_retinanet_x100_32x4d_fpn_1x_multi_scale_split_all_images'
load_from = None
resume_from = None
